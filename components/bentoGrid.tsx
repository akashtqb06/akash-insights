    ...
    >
      {arr.map((_, i) => (
        <motion.div
          ...
          className="flex flex-row rounded-full border border-border  p-2  items-center space-x-2 bg-secondary  w-full h-4"
        ></motion.div>
      ))}
    </motion.div>
  );
...
const SkeletonFour = () => {
  ...
  return (
    ...
    >
      <motion.div
        variants={first}
        className="h-full w-1/3 rounded-2xl bg-background p-4  dark:border-white/[0.1] border border-neutral-200 flex flex-col items-center justify-center"
      >
        <Image
      ...
      <motion.div className="h-full relative z-20 w-1/3 rounded-2xl bg-background p-4  dark:border-white/[0.1] border border-neutral-200 flex flex-col items-center justify-center">
        <Image
          src="https://pbs.twimg.com/profile_images/1417752099488636931/cs2R59eW_400x400.jpg"
          alt="avatar"
          height="100"
